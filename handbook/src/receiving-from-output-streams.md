...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:parsed_streams_struct}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:receive_streams}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:receive_streams_parallel}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:collect_streams}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:query_stream_storage}}
```
