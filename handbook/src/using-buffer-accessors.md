...
{{#include ./examples/handbook_snippets/src/native-snippets.rs:buffer_access_example}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:listen_example}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:gate_example}}
```
