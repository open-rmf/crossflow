...
{{#include ./examples/handbook_snippets/src/diagram-snippets.rs:minimal_multiply_by_example}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/diagram-snippets.rs:default_display_text}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/diagram-snippets.rs:node_builder_description}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/diagram-snippets.rs:custom_config}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/diagram-snippets.rs:custom_config_with_examples}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/diagram-snippets.rs:division_example}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/diagram-snippets.rs:get_url_header_example}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/diagram-snippets.rs:opt_out_example}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/diagram-snippets.rs:state_update_example}}
```
