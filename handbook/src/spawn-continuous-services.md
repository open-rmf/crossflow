...
{{#include ./examples/handbook_snippets/src/native-snippets.rs:hello_continuous_service}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:spawn_hello_continuous_service}}
```
