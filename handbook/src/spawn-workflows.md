...
{{#include ./examples/handbook_snippets/src/native-snippets.rs:trivial_workflow}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:trivial_workflow_concise}}
```
