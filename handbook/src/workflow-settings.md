...
{{#include ./examples/handbook_snippets/src/native-snippets.rs:explicit_workflow_settings}}
```

#### `DeliverySettings`

```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:explicit_delivery_settings}}
```

#### `ScopeSettings`

```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:explicit_scope_settings}}
```

#### Default

```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:default_workflow_settings}}
```
...
```rust,no_run,noplayground
{{#include ./examples/handbook_snippets/src/native-snippets.rs:inner_scope_settings}}
```
