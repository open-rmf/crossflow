...
{{#include ./examples/native/src/handbook_snippets.rs:chain_services}}
```
...
```rust,no_run,noplayground
{{#include ./examples/native/src/handbook_snippets.rs:chain_maps}}
```
...
```rust,no_run,noplayground
{{#include ./examples/native/src/handbook_snippets.rs:fork_result_chain}}
```
...
```rust,no_run,noplayground
{{#include ./examples/native/src/handbook_snippets.rs:branch_for_err}}
```
...
```rust,no_run,noplayground
{{#include ./examples/native/src/handbook_snippets.rs:fork_option_chain}}
```
...
```rust,no_run,noplayground
{{#include ./examples/native/src/handbook_snippets.rs:emergency_stop_chain}}
```
...
```rust,no_run,noplayground
{{#include ./examples/native/src/handbook_snippets.rs:use_elevator_chain}}
```
